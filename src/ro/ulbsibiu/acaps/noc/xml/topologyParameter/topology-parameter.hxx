...
/**
 * @file
 * @brief Generated from topology-parameter.xsd.
 */

#ifndef SRC_RO_ULBSIBIU_ACAPS_NOC_XML_SCHEMA_TOPOLOGY_PARAMETER_HXX
#define SRC_RO_ULBSIBIU_ACAPS_NOC_XML_SCHEMA_TOPOLOGY_PARAMETER_HXX
  ...
  namespace noc
  {
    namespace application_mapping
    {
      namespace unified_framework
      {
        ...
        {
          /**
           * @brief C++ namespace for the %http://webspace.ulbsibiu.ro/ciprian.radu/research/noc/application_mapping/unified_framework/schema/topologyParameter
           * schema namespace.
           */
          namespace topologyParameter
          {
            /**
             * @brief Class corresponding to the %topologyType schema type.
             *
             * @nosubgrouping
             */
            class topologyType: public ::xml_schema::type
            {
              public:
              /**
               ...
               * sequence element.
               *
               * Alows us to set the characteristics of the toplogy.
               */
              //@{
               ...
               * @brief Element type.
               */
              typedef ::research::noc::application_mapping::unified_framework::schema::topologyParameter::topologyParameterType topologyParameter_type;
            ...
            class topologyParameterType: public ::xml_schema::type
            {
               ...
               * initializers for required elements and attributes.
               */
              topologyParameterType (const type_type&);
    ...
    namespace application_mapping
    {
      namespace unified_framework
      {
        namespace schema
        {
          ...
          {
            /**
             * @name Parsing functions for the %topology document root.
             *
             * XML schema that describes the characteristics of a topology.
             */
            //@{
             ...
             */
            ::std::auto_ptr< ::research::noc::application_mapping::unified_framework::schema::topologyParameter::topologyType >
            topology (::xercesc::InputSource& is,
                      ::xml_schema::flags f = 0,
                      const ::xml_schema::properties& p = ::xml_schema::properties ());
    ...
    namespace application_mapping
    {
      namespace unified_framework
      {
        namespace schema
        {
          ...
          {
            void
            operator<< (::xercesc::DOMElement&, const topologyType&);

            /**
             * @name Serialization functions for the %topology document root.
             *
             * XML schema that describes the characteristics of a topology.
             */
            //@{
             ...
             */
            void
            topology (::std::ostream& os,
                      const ::research::noc::application_mapping::unified_framework::schema::topologyParameter::topologyType& x, 
             ...
             */
            void
            topology (::xercesc::XMLFormatTarget& ft,
                      const ::research::noc::application_mapping::unified_framework::schema::topologyParameter::topologyType& x, 
                      const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                      const ::std::string& e = "UTF-8",
                      ::xml_schema::flags f = 0);
            ...
            topology (const ::research::noc::application_mapping::unified_framework::schema::topologyParameter::topologyType& x, 
                      const ::xml_schema::namespace_infomap& m = ::xml_schema::namespace_infomap (),
                      ::xml_schema::flags f = 0);
...
#endif // SRC_RO_ULBSIBIU_ACAPS_NOC_XML_SCHEMA_TOPOLOGY_PARAMETER_HXX
